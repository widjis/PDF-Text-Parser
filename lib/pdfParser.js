...
class PDFParser {
  ...
  /**
   * Parse PDF using OpenAI Responses API (Direct PDF Processing with Base64)
  ...
  async parseWithOpenAIResponses(buffer, fileName) {
    ...
    try {
      ...
      console.log('🔍 Processing PDF with OpenAI Responses API using base64...');
      
      // Use the Responses API to process the PDF with base64 data
      ...
      return {
        ...
        metadata: {
          ...
          note: 'Text extracted using OpenAI Responses API with base64 PDF processing (no file upload)',
